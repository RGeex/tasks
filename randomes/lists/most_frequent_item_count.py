...
Предположим, что на вход подается массив целых чисел. Для пустого массива верните значение функции. 0
Пример
...
def most_frequent_item_count_2(collection: List[int]) -> int:
    """
    Определяет макс кол-во повторяющегося элементиа в списке.
    """
...
if __name__ == '__main__':
    ...
    test(most_frequent_item_count_2, (
        ([3, -1, -1], 2),
        ([3, -1, -1, -1, 2, 3, -1, 3, -1, 2, 4, 9, 3], 5),
        ([], 0),
        ([9], 1),
